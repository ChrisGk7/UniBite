...
('Αντρέας', 'agg@gmail.com', '$2y$10$l3wjduJrbk/CJ0Ud3hu3YeaETEFq6llSKJ9JREEJnG4bQ2ChhdjFG', 'Αντρέας Κορακιανίτης', '2026-09-12 11:27:38'),
('Βαγγέλης', 'vagg123@gmail.com', '$2y$10$c1Tz/50vvIU.EuOghDqap.9dN0sn5tcCJNwaCR6YbII.E6kXms11a', 'Ιωαννίδης', '2026-09-11 20:45:25');


INSERT INTO `student` (`username`, `email`, `credits`, `street`, `number`, `city`, `postcode`, `mobile`) VALUES
('Chrizz', '6909878289.chris@gmail.com', 6, 'Zakinthou', 84, 'Patras', 26441, '6988441990'),
('JohnP', 'GP@gmail.com', 3, 'CORFU', 1, 'CORFU', 49084, '+306977894499'),
('Lemonia', 'LM@gmail.com', 13, 'CORFU', 1, 'CORFU', 49084, '+306973902768'),
('testakos1', 'dimvri112@gmail.com', 5, 'PATMOY', 7, 'PATRA', 49100, '+306945056779'),
...
('Αντρέας', 'agg@gmail.com', 11, 'Ρηγα Φεραίου', 55, 'Πατρα', 26500, '+306912345677'),
('Βαγγέλης', 'vagg123@gmail.com', 0, 'Κορίνθου', 85, 'PATRA', 26300, '+306912345678');
...
('Αντρέας', 'agg@gmail.com', 'Ρηγα Φεραίου', 55, 'Πατρα', 26500, '+306912345677', 6),
('Βαγγέλης', 'vagg123@gmail.com', 'Κορίνθου', 85, 'PATRA', 26300, '+306912345678', 0);
...
(28, 'Chrizz', 'Μακαρόνια με Κιμά', ':)', 'Γλουτενη', 'uploads/makaronia.png', 'Ζακύνθου 85', '2026-09-24 20:55:00', 38.2576218, 21.7456824, 5, 1, '2026-09-24 10:04:58'),
(29, 'Chrizz', 'Παστιτσάδα', ';)', 'Allergens: Γλουτενη, Λακτοζη', 'uploads/images_pastitsada.png', 'Ζακύνθου 85', '2026-09-24 22:09:00', 38.2574288, 21.7456609, 4, 1, '2026-09-24 10:09:44'),
(30, 'Αντρέας', 'Γεμιστά', 'περιγραφή', 'ντομάτα', 'uploads/γεμιστα.jpg', 'Κανακάρη 32', '2026-09-23 11:40:00', 38.2474670, 21.7385627, 13, 1, '2026-09-12 11:40:11'),
(31, 'Αντρέας', 'κεφτεδάκια', 'περιγραφή για τα κεφτεδάκια', 'κιμάς', 'uploads/κεφτεδακια.jpg', 'Ραδινού 58', '2026-09-20 11:41:00', 38.2484823, 21.7368973, 0, 1, '2026-09-12 11:41:13'),
(33, 'Αντρέας', 'Σπανακόπιτα', 'Σπιτική σπανακόπιτα', 'Γάλα, Αυγό', 'uploads/σπανακοπιτα.jpg', 'Κορινθου 180', '2026-09-25 16:15:00', 38.2503518, 21.7411876, 11, 1, '2026-09-24 10:09:35'),
(34, 'Αντρέας', 'Φασολάδα', 'Φασολάδα με πάπρικα και κόκκινο πιπέρι.', 'Allergens: Φασόλι', 'uploads/φασολακια.jpg', 'Κορινθου 98', '2026-09-26 15:17:00', 38.2444284, 21.7335177, 9, 1, '2026-09-24 10:12:04'),
(35, 'JohnP', 'Cinammon Rolls', 'Μου έμειναν απο Wolt.', 'Γλουτενη, Λακτοζη', 'uploads/cinnamon_rolls.jpeg', 'Κανακάρη 109', '2026-09-24 19:35:00', 38.2471258, 21.7384028, 2, 1, '2026-09-24 10:45:59');
...
(11, 'testakos1', 'testakos2', 3, 3, 3, 'accepted', 'picked_up', NULL, '2026-09-06 10:34:29', '2026-09-06 10:34:50', '2026-09-06 10:35:26', '2026-09-11 20:43:43'),
...
(26, 'Chrizz', 'JohnP', 26, 1, 1, 'accepted', 'picked_up', NULL, '2026-09-07 12:37:00', '2026-09-07 13:31:08', '2026-09-07 13:31:17', '2026-09-24 10:39:43'),
...
(28, 'JohnP', 'Chrizz', 23, 5, 5, 'declined', NULL, NULL, '2026-09-07 13:34:00', '2026-09-24 10:40:00', NULL, NULL),
(29, 'JohnP', 'Chrizz', 23, 5, 5, 'declined', NULL, NULL, '2026-09-07 13:35:01', '2026-09-24 10:39:58', NULL, NULL),
(30, 'Βαγγέλης', 'Αντρέας', 31, 3, 3, 'accepted', 'picked_up', NULL, '2026-09-12 11:44:05', '2026-09-12 11:50:15', '2026-09-12 11:50:43', '2026-09-18 13:34:23');
